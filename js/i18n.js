...
const I18N_DICT = {
  en: {
    ...
    'nav.logIn': 'Log in', 'nav.signUp': 'Create account', 'nav.logOut': 'Log out',
    ...
    'auth.signUp': 'Create Account', 'auth.signUpSub': 'Create your account.',
    ...
    'chat.loginGate': 'You need an account to post. {signup} — it takes a minute.',
    'chat.newMessage': 'New message\u2026', 'chat.messageUsernamePlaceholder': 'Message a username\u2026', 'chat.searchUserTrigger': 'Search people, groups & channels\u2026', 'chat.searchUserPlaceholder': 'Search people, groups & channels\u2026',
    ...
    'chat.noSearchResults': 'No messages match your search.',
    'chat.clearChat': 'Clear chat',
    'chat.clearChatTitle': 'Clear this chat?',
    'chat.clearChatDesc': 'This clears your view of the chat with {username}. {username} will still see their side, and new messages will still come through.',
    'chat.chatCleared': 'Chat cleared.',
    'chat.blockUser': 'Block {username}',
    'chat.unblockUser': 'Unblock {username}',
    'chat.blockTitle': 'Block {username}?',
    'chat.blockDesc': "They won't be able to message or follow you, and you'll stop following each other.",
    'chat.blockedNotice': "You've blocked {username}. Unblock them to send a message.",
  ...
  es: {
    ...
    'nav.logIn': 'Iniciar sesión', 'nav.signUp': 'Crear cuenta', 'nav.logOut': 'Cerrar sesión',
    ...
    'auth.signUp': 'Crear cuenta', 'auth.signUpSub': 'Crea tu cuenta.',
    ...
    'chat.loginGate': 'Necesitas una cuenta para publicar. {signup} — solo toma un minuto.',
    'chat.newMessage': 'Nuevo mensaje\u2026', 'chat.messageUsernamePlaceholder': 'Mensaje a un usuario\u2026', 'chat.searchUserTrigger': 'Buscar personas, grupos y canales\u2026', 'chat.searchUserPlaceholder': 'Busca personas, grupos y canales p\u00fablicos\u2026',
  ...
  fr: {
    ...
    'nav.logIn': 'Connexion', 'nav.signUp': 'Créer un compte', 'nav.logOut': 'Déconnexion',
    ...
    'auth.signUp': 'Créer un compte', 'auth.signUpSub': 'Créez votre compte.',
    ...
    'chat.loginGate': 'Vous devez avoir un compte pour publier. {signup} — ça ne prend qu\'une minute.',
    'chat.newMessage': 'Nouveau message\u2026', 'chat.messageUsernamePlaceholder': "Envoyer un message à un utilisateur\u2026", 'chat.searchUserTrigger': 'Rechercher des personnes, groupes et cha\u00eenes\u2026', 'chat.searchUserPlaceholder': "Recherchez des personnes, groupes ou cha\u00eenes publiques\u2026",
  ...
  de: {
    ...
    'nav.logIn': 'Anmelden', 'nav.signUp': 'Konto erstellen', 'nav.logOut': 'Abmelden',
    ...
    'auth.signUp': 'Konto erstellen', 'auth.signUpSub': 'Erstelle dein Konto.',
    ...
    'chat.loginGate': 'Du brauchst ein Konto, um zu posten. {signup} — es dauert nur eine Minute.',
    'chat.newMessage': 'Neue Nachricht\u2026', 'chat.messageUsernamePlaceholder': 'Nachricht an einen Benutzernamen\u2026', 'chat.searchUserTrigger': 'Personen, Gruppen & Kan\u00e4le suchen\u2026', 'chat.searchUserPlaceholder': 'Suche Personen oder \u00f6ffentliche Gruppen/Kan\u00e4le\u2026',
  ...
  pt: {
    ...
    'nav.logIn': 'Entrar', 'nav.signUp': 'Criar conta', 'nav.logOut': 'Sair',
    ...
    'auth.signUp': 'Criar conta', 'auth.signUpSub': 'Crie sua conta.',
    ...
    'chat.loginGate': 'Você precisa de uma conta para postar. {signup} — leva só um minuto.',
    'chat.newMessage': 'Nova mensagem\u2026', 'chat.messageUsernamePlaceholder': 'Mensagem para um usuário\u2026', 'chat.searchUserTrigger': 'Buscar pessoas, grupos e canais\u2026', 'chat.searchUserPlaceholder': 'Busque pessoas ou grupos/canais p\u00fablicos\u2026',
  ...
  ja: {
    ...
    'nav.logIn': 'ログイン', 'nav.signUp': 'アカウントを作成', 'nav.logOut': 'ログアウト',
    ...
    'auth.signUp': 'アカウントを作成', 'auth.signUpSub': 'アカウントを作成しましょう。',
    ...
    'chat.loginGate': '投稿するにはアカウントが必要です。{signup} — 1分もかかりません。',
    'chat.newMessage': '新規メッセージ\u2026', 'chat.messageUsernamePlaceholder': 'ユーザー名を指定してメッセージ\u2026', 'chat.searchUserTrigger': 'ユーザー・グループ・チャンネルを検索\u2026', 'chat.searchUserPlaceholder': 'ユーザーや公開グループ・チャンネルを検索\u2026',
  ...
  ru: {
    ...
    'nav.logIn': 'Войти', 'nav.signUp': 'Создать аккаунт', 'nav.logOut': 'Выйти',
    'compose.placeholder': 'Что происходит?',
    'compose.reply': 'Опубликуйте ваш ответ',
    'post.viewMore': 'Показать больше',
    'post.viewLess': 'Показать меньше',
    ...
    'auth.signUp': 'Создать аккаунт', 'auth.signUpSub': 'Создайте свой аккаунт.',
    ...
    'chat.loginGate': 'Чтобы публиковать, нужен аккаунт. {signup} — это займёт всего минуту.',
    'chat.newMessage': 'Новое сообщение\u2026', 'chat.messageUsernamePlaceholder': 'Написать пользователю\u2026', 'chat.searchUserTrigger': 'Поиск людей, групп и каналов\u2026', 'chat.searchUserPlaceholder': 'Найдите пользователя или публичную группу/канал\u2026',
