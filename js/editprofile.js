...
async function loadEditProfile() {
  ...
  if (!session) {
    root.innerHTML = `<div class="post-login-gate" style="border-top:none;">Log in to edit your profile. <a href="login.html">Log in</a> or <a href="signup.html">create an account</a>.</div>`;
    return;
  }
