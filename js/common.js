...
// anyone) is logged in.
const NAV_ICON = {
  home:     '<svg viewBox="0 0 24 24"><path d="M4.5 11.6 11.15 5.35a1.35 1.35 0 0 1 1.7 0L19.5 11.6"/><path d="M6.1 10.15V17.6a1.9 1.9 0 0 0 1.9 1.9h1.7a1 1 0 0 0 1-1v-3.55c0-.75.6-1.35 1.35-1.35h.9c.75 0 1.35.6 1.35 1.35V18.5a1 1 0 0 0 1 1h1.7a1.9 1.9 0 0 0 1.9-1.9v-7.45"/></svg>',
  search:   '<svg viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="6.75"/><path d="m20 20-4.55-4.55"/></svg>',
  bell:     '<svg viewBox="0 0 24 24"><path d="M12 3.6a5.9 5.9 0 0 0-5.9 5.9v2.55c0 .8-.3 1.57-.83 2.16l-1 1.1c-.9.99-.2 2.6 1.14 2.6h13.18c1.34 0 2.04-1.61 1.14-2.6l-1-1.1a3.3 3.3 0 0 1-.83-2.16V9.5A5.9 5.9 0 0 0 12 3.6Z" fill="currentColor" stroke="none"/><path d="M9.7 19.3a2.3 2.3 0 0 0 4.6 0" fill="currentColor" stroke="none"/></svg>',
  ...
  user:     '<svg viewBox="0 0 24 24"><circle cx="12" cy="8.1" r="3.6"/><path d="M5.2 19c.55-3.5 3-5.4 6.8-5.4s6.25 1.9 6.8 5.4"/></svg>',
  gear:     '<svg viewBox="0 0 24 24"><path d="M20.76 12 20.14 12.53 19.19 12.95 18.15 13.22 17.31 13.42 16.84 13.64 16.85 14.01 17.24 14.58 17.85 15.38 18.42 16.29 18.75 17.18 18.68 17.86 18.19 18.19 17.38 18.13 16.53 17.86 15.62 17.62 14.75 17.6 14.35 17.87 14.14 18.47 13.99 19.38 13.7 20.32 13.14 20.99 12.42 21.19 11.7 20.99 11.14 20.32 10.85 19.38 10.7 18.47 10.49 17.87 10.09 17.6 9.22 17.62 8.31 17.86 7.46 18.13 6.65 18.19 6.16 17.86 6.09 17.18 6.42 16.29 6.99 15.38 7.6 14.58 7.99 14.01 8 13.64 7.53 13.42 6.69 13.22 5.65 12.95 4.7 12.53 4.08 12 4.7 11.47 5.65 11.05 6.69 10.78 7.53 10.58 8 10.36 7.99 9.99 7.6 9.42 6.99 8.62 6.42 7.71 6.09 6.82 6.16 6.14 6.65 5.81 7.46 5.87 8.31 6.14 9.22 6.38 10.09 6.4 10.49 6.13 10.7 5.53 10.85 4.62 10.99 3.68 11.14 3.01 11.7 2.81 12.42 3.01 13.14 3.68 13.99 4.62 14.14 5.53 14.35 6.13 14.75 6.4 15.62 6.38 16.53 6.14 17.38 5.87 18.19 5.81 18.68 6.14 18.75 6.82 18.42 7.71 17.85 8.62 17.24 9.42 16.85 9.99 16.84 10.36 17.31 10.58 18.15 10.78 19.19 11.05 20.14 11.47 20.76 12Z"/><circle cx="12" cy="12" r="2.5"/></svg>',
  globe:    '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="8.6"/><ellipse cx="12" cy="12" rx="3.6" ry="8.6"/><path d="M3.4 12h17.2M4.6 8h14.8M4.6 16h14.8"/></svg>',
  palette:  '<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 3.5C7 3.5 2.9 7.3 2.9 12S7 20.5 12 20.5c1.1 0 2-.9 2-2 0-.5-.2-.95-.5-1.3-.3-.35-.5-.8-.5-1.3 0-1.1.9-2 2-2h2.3c2.1 0 3.8-1.7 3.8-3.8 0-3.6-4-6.6-9.1-6.6Z"/><circle cx="7.4" cy="11.2" r="1.4" fill="var(--bg,#fff)"/><circle cx="9.4" cy="7.8" r="1.4" fill="var(--bg,#fff)"/><circle cx="13.4" cy="7.4" r="1.4" fill="var(--bg,#fff)"/><circle cx="16.3" cy="9.6" r="1.4" fill="var(--bg,#fff)"/></svg>',
  ...
  people:   '<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><circle cx="6.3" cy="9.3" r="2.7"/><path d="M1.5 17.5c.55-3 2.3-4.6 4.8-4.6.85 0 1.6.18 2.25.53-.85.95-1.4 2.3-1.65 4.07Z"/><circle cx="17.7" cy="9.3" r="2.7"/><path d="M22.5 17.5c-.55-3-2.3-4.6-4.8-4.6-.85 0-1.6.18-2.25.53.85.95 1.4 2.3 1.65 4.07Z"/><circle cx="12" cy="11" r="3.1"/><path d="M6.6 19.3c.55-3.4 2.5-5.15 5.4-5.15s4.85 1.75 5.4 5.15Z"/></svg>',
