...
const ICON = {
  ...
  views:    '<svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>',
...
const NAV_ICON = {
  ...
  gear:     '<svg viewBox="0 0 24 24"><path d="M12 15.2a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4Z"/><path d="M19.4 13.6c.05-.53.05-1.07 0-1.6l1.9-1.4a.6.6 0 0 0 .15-.77l-1.8-3.1a.6.6 0 0 0-.73-.26l-2.2.85a7.6 7.6 0 0 0-1.4-.8l-.35-2.35a.6.6 0 0 0-.6-.5h-3.6a.6.6 0 0 0-.6.5l-.34 2.35c-.5.2-.98.47-1.4.8l-2.2-.85a.6.6 0 0 0-.74.26l-1.8 3.1a.6.6 0 0 0 .15.77l1.9 1.4c-.06.53-.06 1.07 0 1.6l-1.9 1.4a.6.6 0 0 0-.15.78l1.8 3.1c.15.26.47.36.74.25l2.2-.85c.42.34.9.6 1.4.8l.35 2.36c.04.29.3.5.6.5h3.6c.3 0 .55-.21.6-.5l.34-2.36c.5-.2.98-.46 1.4-.8l2.2.85c.27.11.59.01.74-.25l1.8-3.1a.6.6 0 0 0-.15-.79l-1.9-1.4Z"/></svg>',
