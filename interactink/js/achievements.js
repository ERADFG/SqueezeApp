...
const ACHV_ICON_MAP = {
  ...
  list_with_5_members: achvSvg('<circle cx="8" cy="8" r="3"/><path d="M2.5 20c0-3.6 2.5-6 5.5-6s5.5 2.4 5.5 6"/><circle cx="17.5" cy="7" r="2.3"/><path d="M14 13.8c2.6.3 4.7 2.5 4.7 5.7"/>'),
  ...
  joined:               achvSvg('<path d="M21 3 10 14"/><path d="M21 3 14 21 10 14 3 10Z"/>'),
...
async function loadAchievements() {
  ...
  if (!session) {
    root.innerHTML = `<div class="post-login-gate" style="border-top:none;">You need an account to post. <a href="/signup">Create an account</a> — it takes a minute.</div>`;
    return;
  }
