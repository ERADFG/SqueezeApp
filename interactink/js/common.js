...
const RESERVED_TOP_LEVEL = new Set(['home','notifications','messages','bookmarks','settings','search','login','signup','rules','i','communities','lists','articles','about','contact','privacy','terms','achievements','insights','editprofile','start','admin','help','blog']);
...
const NAV_ICON = {
  ...
  gear:     '<svg viewBox="0 0 24 24"><path d="M10.56 3.63Q10.95 2.76 11.90 2.76L12.10 2.76Q13.05 2.76 13.44 3.63L14.10 5.13Q14.49 5.99 15.37 5.65L16.90 5.06Q17.79 4.72 18.46 5.39L18.61 5.54Q19.28 6.21 18.94 7.10L18.35 8.63Q18.01 9.51 18.87 9.90L20.37 10.56Q21.24 10.95 21.24 11.90L21.24 12.10Q21.24 13.05 20.37 13.44L18.87 14.10Q18.01 14.49 18.35 15.37L18.94 16.90Q19.28 17.79 18.61 18.46L18.46 18.61Q17.79 19.28 16.90 18.94L15.37 18.35Q14.49 18.01 14.10 18.87L13.44 20.37Q13.05 21.24 12.10 21.24L11.90 21.24Q10.95 21.24 10.56 20.37L9.90 18.87Q9.51 18.01 8.63 18.35L7.10 18.94Q6.21 19.28 5.54 18.61L5.39 18.46Q4.72 17.79 5.06 16.90L5.65 15.37Q5.99 14.49 5.13 14.10L3.63 13.44Q2.76 13.05 2.76 12.10L2.76 11.90Q2.76 10.95 3.63 10.56L5.13 9.90Q5.99 9.51 5.65 8.63L5.06 7.10Q4.72 6.21 5.39 5.54L5.54 5.39Q6.21 4.72 7.10 5.06L8.63 5.65Q9.51 5.99 9.90 5.13L10.56 3.63Z"/><circle cx="12" cy="12" r="3.3"/></svg>',
  ...
  trophy:   '<svg viewBox="0 0 24 24"><path d="M7.6 4.2h8.8v4.4c0 3.15-1.95 5.7-4.4 5.7s-4.4-2.55-4.4-5.7Z" stroke-linejoin="round"/><path d="M7.6 5.3H5.1c0 2.5.85 4.15 2.75 4.6M16.4 5.3h2.5c0 2.5-.85 4.15-2.75 4.6"/><path d="M12 14.3v3.1M9 19.6h6" stroke-linecap="round"/></svg>'
};
...
async function checkMediaModeration(table, contentId, contentType, mediaUrl, mediaType, transcript) {
  try {
    const res = await fetch('/api/moderate-media', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        userId: currentSession.user.id, table, contentId, contentType, mediaUrl, mediaType, transcript,
      }),
    });
...
async function renderMyCommunities() {
  ...
  if (!currentSession) {
    box.innerHTML = header + createRow +
      `<a class="show-more" href="/communities">Browse communities</a>`;
    return;
  }
  ...
  box.innerHTML = header + createRow +
    ...
    `<a class="show-more" href="/communities">${mine.length ? 'See all' : 'Browse communities'}</a>`;
}
